...
# if __name__ == '__main__':
    ...
    # lrange = get_data_by_index(list_name, r, -1)
    # print(lrange, type(lrange))

    # add_to_list(list_name, r, 'test5')
    #

    #
    # # append_to_list(list_name, r, 'test')
    #
    # lrange = get_data_by_index(list_name, r, 0)
    # print(lrange, type(lrange))
    #
    # lrange = get_all_list_data(list_name, r)
    # c = 0
    # for i in lrange:
    #     c += 1
    #     print(c, i, type(i))